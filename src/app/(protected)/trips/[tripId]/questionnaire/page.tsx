  ...
  return (
    <div className="mx-auto max-w-xl rounded-card bg-white p-8 text-center shadow-card">
      ...
      <p className="mt-3 text-neutral-700">
        This trip could not be opened from the current session. It may have been deleted, or it may
        belong to another account.
      </p>
      <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
        <Link
          href={ROUTES.DASHBOARD}
          className="transition-ui inline-flex min-h-11 items-center justify-center rounded-card bg-primary-500 px-5 py-2.5 text-base font-semibold text-white shadow-card hover:bg-primary-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
        >
          Back to dashboard
        </Link>
        <Link
          href={ROUTES.NEW_TRIP}
          className="transition-ui inline-flex min-h-11 items-center justify-center rounded-card border border-neutral-200 bg-white px-5 py-2.5 text-base font-semibold text-neutral-900 shadow-card hover:bg-neutral-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
        >
          Start a new trip
        </Link>
      </div>
